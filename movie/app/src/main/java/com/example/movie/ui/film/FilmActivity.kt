...
@AndroidEntryPoint
class FilmActivity : BaseActivity<ActivityFilmBinding>() {
    ...
    override fun getLayoutBinding(): ActivityFilmBinding =
    ...
    private fun onDataChange() {
        defaultObserver(viewModel.film, null, null) {
            if (it != null) {
                rs = it
                binding.f = it
        ...
        defaultObserver(viewModel.video, null, null) {
        ...
        defaultObserver(viewModel.casts, null, null) {
            it?.let {
